...
#
# .. your code here ..
data_train, data_test, label_train, label_test = train_test_split(df, face_labels, test_size = 0.1, random_state=7)
...
if Test_PCA:
  ...
  isomap.fit(data_train)
  data_train= isomap.transform(data_train)
